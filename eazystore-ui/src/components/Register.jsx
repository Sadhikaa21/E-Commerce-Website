...
export default function Register() {
  ...
  return (
    <div className="min-h-[752px] flex items-center justify-center font-primary bg-gray-100">
      <div className="bg-white shadow-md rounded-lg max-w-md w-full px-8 py-6">
        ...
        >
          ...
          <button
            ...
            className="w-full px-6 py-2 text-white text-xl bg-primary hover:bg-dark rounded-md transition duration-200"
          >
