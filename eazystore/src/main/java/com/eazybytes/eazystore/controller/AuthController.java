...
//    private final InMemoryUserDetailsManager inMemoryUserDetailsManager; this was req until we dint create a database to store cust details,so we used to store it in local memory
...
//                List.of(new SimpleGrantedAuthority("USER"))));
        ...
        BeanUtils.copyProperties(registerRequestDto, customer); //once created the object,copy the details from dto customerentity object with the help of beanutils...  source object will be register request dto and dest obj will be customer
