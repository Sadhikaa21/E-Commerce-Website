...
@Slf4j
//to tell what to do on exception
public class GlobalExceptionHandler {
    @ExceptionHandler(Exception.class)
//    the Exception.class handles all exceptions since exception is the superclass to all Exceptions,if u want nullException or any specific,you can replace it there
